...
n = st.sidebar.slider('image width in symbols', min_value=1, max_value=200)
image_size = st.sidebar.slider('image width in pixels', min_value=2, max_value=3000)
...
red = st.sidebar.slider('red', min_value=0, max_value=256, value=256)
green = st.sidebar.slider('green', min_value=0, max_value=256, value=256)
blue = st.sidebar.slider('blue', min_value=0, max_value=256, value=256)
...
ax.scatter(dots_x, dots_y, s=pixelsize, c=colors, alpha=alpha/100, marker=marker)
ax.axis('off')
ax.set_ylim(0,n+1)
ax.set_xlim(0,n+1)
